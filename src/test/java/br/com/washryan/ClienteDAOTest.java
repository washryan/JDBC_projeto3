...
public class ClienteDAOTest {
	...
	public void pesquisarCliente() throws MaisDeUmRegistroException, TableException, TipoChaveNaoEncontradaException, DAOException {
		...
		cliente.setEmail("rodrigo@teste.com");
		clienteDao.cadastrar(cliente);
		
		Cliente clienteConsultado = clienteDao.consultar(cliente.getCpf());
		Assert.assertNotNull(clienteConsultado);
		Assert.assertEquals("rodrigo@teste.com", clienteConsultado.getEmail());
	...
	public void salvarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		cliente.setNumero(10);
		cliente.setTel(1199999999L);
		cliente.setEmail("rodrigo.salvar@teste.com");
		Boolean retorno = clienteDao.cadastrar(cliente);
		Assert.assertTrue(retorno);
		
		Cliente clienteConsultado = clienteDao.consultar(cliente.getCpf());
		Assert.assertNotNull(clienteConsultado);
		Assert.assertEquals("rodrigo.salvar@teste.com", clienteConsultado.getEmail());
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		cliente.setNumero(10);
		cliente.setTel(1199999999L);
		cliente.setEmail("rodrigo.original@teste.com");
		Boolean retorno = clienteDao.cadastrar(cliente);
		Assert.assertTrue(retorno);
		...
		clienteConsultado.setEmail("rodrigo.alterado@teste.com");
		clienteDao.alterar(clienteConsultado);
		
		Cliente clienteAlterado = clienteDao.consultar(clienteConsultado.getCpf());
		Assert.assertNotNull(clienteAlterado);
		Assert.assertEquals("Rodrigo Pires", clienteAlterado.getNome());
		Assert.assertEquals("rodrigo.alterado@teste.com", clienteAlterado.getEmail());
